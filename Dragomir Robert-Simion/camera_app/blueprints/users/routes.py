...
from camera_app import db, bcrypt, login_manager
from camera_app.blueprints.users.models import User
from camera_app.blueprints.users.forms import Form_Registration, Form_Login, Form_Update_Password
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(request.args.get('next', url_for('main.photos')))
        else:
