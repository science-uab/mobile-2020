document.getElementById("submit_btn").addEventListener("click",get_checked_1);
document.getElementById("submit_btn").addEventListener("click",get_checked_2);
document.getElementById("submit_btn").addEventListener("click",get_checked_3);
document.getElementById("submit_btn").addEventListener("click",get_checked_4);
document.getElementById("submit_btn").addEventListener("click",get_grade);
s=2;
