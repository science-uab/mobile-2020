...
public class HowToActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public HowToActivity_ViewBinding(HowToActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public HowToActivity_ViewBinding(final HowToActivity target, View source) {
    this.target = target;
    ...
    target.wvHowTo = Utils.findRequiredViewAsType(source, R.id.wv_how_to, "field 'wvHowTo'", WebView.class);
  ...
  @CallSuper
  public void unbind() {
    HowToActivity target = this.target;
