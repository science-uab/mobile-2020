...
public class PrivacyActivity extends MusicPlayerActivity {
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Intent intent = new Intent(PrivacyActivity.this, MusicPlayerService.class);

            boolean playMusic = PreferenceManager.getDefaultSharedPreferences(PrivacyActivity.this).getBoolean(getString(R.string.pref_key_music), true);
    ...
    private void init() {
        ...
        tvToolbarTitle.setText(getString(R.string.privacy_policy));


        wvHowTo.loadUrl(Constants.URL_PRIVACY);

        if (CheckInternet.isNetworkAvailable(PrivacyActivity.this)) {
