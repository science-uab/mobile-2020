document.getElementById("submit_btn_cls_VII").addEventListener("click",get_checked_1);
document.getElementById("submit_btn_cls_VII").addEventListener("click",get_checked_2);
document.getElementById("submit_btn_cls_VII").addEventListener("click",get_checked_3);
document.getElementById("submit_btn_cls_VII").addEventListener("click",get_checked_4);
document.getElementById("submit_btn_cls_VII").addEventListener("click",get_grade);
s=2;
...
function get_grade()
{
	  alert ("Nota examinare clasa a VII-a " + s+" ! ");
